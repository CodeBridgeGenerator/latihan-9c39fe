...
<Column field="status" header="status" body={p_booleanTemplate1} filter={selectedFilterFields.includes("status")} hidden={selectedHideFields?.includes("status")}  sortable style={{ minWidth: "8rem" }} />
